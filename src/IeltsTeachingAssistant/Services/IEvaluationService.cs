...
public interface IEvaluationService
{
    ...
    Task CreateReadingEvaluationAsync(ReadingEvaluation eval);
    Task CreateListeningEvaluationAsync(ListeningEvaluation eval);
    ...
    Task<List<ReadingEvaluation>> GetReadingEvaluationsForStudentAsync(int studentId);
    Task<List<ListeningEvaluation>> GetListeningEvaluationsForStudentAsync(int studentId);
